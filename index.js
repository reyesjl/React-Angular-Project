    ...
    if (!title || !date || !location) {
        ...
        try {
            ...
            if (workshopResponse.rowCount == 0) {
                ...
                const attendeesTemplate = "SELECT firstname, lastname FROM users JOIN attending ON users.username = attending.username WHERE workshopid = (SELECT workshopid FROM workshops WHERE wsname = $1 AND wsdate = $2 AND wslocation = $3)";
